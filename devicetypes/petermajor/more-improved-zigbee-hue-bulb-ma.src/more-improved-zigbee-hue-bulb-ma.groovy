...
metadata {
	...
	definition (name: "More Improved Zigbee Hue Bulb MA", namespace: "petermajor", author: "Peter Major") {
	...
	tiles (scale: 2){
		...
		standardTile("relax", "device.preset", decoration: "flat") {
			state "default", label:"rela", action:"applyRelax"
		}
		standardTile("concentrate", "device.preset", decoration: "flat") {
			state "default", label:"conc", action:"applyConcentrate"
		}
		standardTile("reading", "device.preset", decoration: "flat") {
			state "default", label:"read", action:"applyReading"
		}
		standardTile("energize", "device.preset", decoration: "flat") {
			state "default", label:"ener", action:"applyEnergize"
		}
        
        
		main(["switch"])
		details(["switch", "levelSliderControl", "colorName", "colorTempSliderControl", "colorTemp", "colorMode", "refresh", "relax", "concentrate", "reading", "energize"])
	}
}
